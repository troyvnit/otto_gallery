...
// in otto_gallery/test/helpers/test_helpers.dart.
...
import 'package:otto_gallery/models/photo_model.dart' as _i7;
import 'package:otto_gallery/services/api_service.dart' as _i6;
...
class MockApiService extends _i1.Mock implements _i6.ApiService {
  @override
  _i4.Future<List<_i7.PhotoModel>> getPhotos(
    int? page,
    int? limit,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<List<_i7.PhotoModel>>.value(<_i7.PhotoModel>[]),
        returnValueForMissingStub:
            _i4.Future<List<_i7.PhotoModel>>.value(<_i7.PhotoModel>[]),
      ) as _i4.Future<List<_i7.PhotoModel>>);
}
